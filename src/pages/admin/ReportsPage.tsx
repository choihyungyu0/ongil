...
function ReportDetail({ report }: { report: ReportInboxItem }) {
  return (
    <section className="flex min-h-0 min-w-0 flex-col overflow-visible rounded-[18px] border border-blue-100/80 bg-white shadow-[0_18px_44px_rgba(33,91,145,0.08)] xl:overflow-hidden">
      ...
      <div className="flex flex-col gap-4 px-4 pb-4 sm:px-5 sm:pb-5 xl:min-h-0 xl:flex-1">
        ...
        <div className="grid gap-3 md:grid-cols-[minmax(0,1fr)_180px] xl:min-h-0 xl:flex-1">
